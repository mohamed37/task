                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" maxlength="11">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('main.cpassword') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="image" class="col-md-4 col-form-label text-md-end">{{ __('main.avatar') }}</label>

                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control  @error('avatar') is-invalid @enderror" value="{{old('avatar')}}" name="avatar">
